...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		case 0:
			...
			RenderText(TextShader, "MENU SOLAR SYSTEM", 25.0f, SCREEN_HEIGHT - 30.0f, 0.50f, glm::vec3(0.7f, 0.7f, 0.11f));
			RenderText(TextShader, "STARS: 1 (SUN) ", 25.0f, SCREEN_HEIGHT - 55.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
			RenderText(TextShader, "PLANETS: CLICK 1-9 TO SEE PLANNETS ", 25.0f, SCREEN_HEIGHT - 80.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
			RenderText(TextShader, "W: ZOOM OUT ", 25.0f, SCREEN_HEIGHT - 105.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
			RenderText(TextShader, "N: ZOOM IN ", 25.0f, SCREEN_HEIGHT - 130.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
			RenderText(TextShader, "D: TO THE LEFT ", 25.0f, SCREEN_HEIGHT - 155.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
